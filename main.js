...
console.log("name: " + Sketch)
document.getElementById("sketch_to_be_drawn").innerHTML = "Shh! The item you have to draw is - ⭐" + Sketch + "⭐ - let's see if the computer can guess!";timer_counter = 0;
